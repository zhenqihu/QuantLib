...
/*! \file fdblackscholescnvariantvanillaengine.cpp
*/
...
namespace QuantLib {
    ...
    void FdBlackScholesCnVariantVanillaEngine::calculate() const {
    ...
    MakeFdBlackScholesCnVariantVanillaEngine&
    MakeFdBlackScholesCnVariantVanillaEngine::withIllegalLocalVolOverwrite(
        Real illegalLocalVolOverwrite) {
        illegalLocalVolOverwrite_ = illegalLocalVolOverwrite;
        return *this;
    }
