...
/*! \file fdmblackscholesexpfitsolver.hpp
*/

#ifndef quantlib_fdm_black_scholes_exp_fit_solver_hpp
#define quantlib_fdm_black_scholes_exp_fit_solver_hpp
...
namespace QuantLib {
    ...
    class FdmBlackScholesExpFitSolver : public LazyObject {
      public:
        FdmBlackScholesExpFitSolver(
...
#endif /* quantlib_fdm_black_scholes_exp_fit_solver_hpp */
