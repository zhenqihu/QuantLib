...
/*! \file fdmblackscholesexpfitop.hpp \
    \brief Black Scholes linear operator with exponential fitting
*/

#ifndef quantlib_fdm_black_scholes_exp_fit_op_hpp
#define quantlib_fdm_black_scholes_exp_fit_op_hpp
...
namespace QuantLib
{
    ...
    class FdmBlackScholesExpFitOp : public FdmLinearOpComposite
    {
    public:
        FdmBlackScholesExpFitOp(
