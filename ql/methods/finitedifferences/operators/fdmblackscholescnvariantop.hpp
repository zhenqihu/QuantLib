...
/*! \file fdmblackscholescnvariantop.hpp
    \brief Black-Scholes linear operator with Crank-Nicolson variant stencil
*/

#ifndef quantlib_fdm_black_scholes_cn_variant_op_hpp
#define quantlib_fdm_black_scholes_cn_variant_op_hpp
...
namespace QuantLib {
    ...
    class FdmBlackScholesCnVariantOp : public FdmLinearOpComposite {
      public:
        FdmBlackScholesCnVariantOp(
      ...
      private:
        ...
        FdmWeightedValueOp weightedValueMap_;
