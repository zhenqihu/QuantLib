...
#include "fdblackscholesdiscretedoublebarrierenginehelper.hpp"
...
namespace QuantLib {
    ...
    void FdBlackScholesCnVariantDiscreteDoubleBarrierEngine::calculate() const {
        const FdBlackScholesDiscreteDoubleBarrierSolverSetup setup =
